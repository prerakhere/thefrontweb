  ...
  return (
    <Container>
      <div className="flex flex-col justify-center items-center mt-8">
        <Image
          src="/static/images/prerakAvatar.png"
          layout="fixed"
          width={180}
          height={180}
          priority
        ...
        <div className="mt-4 max-w-xs">
          <p className="text-center">
            Hey there! I am Prerak. This blog is where I write and learn about
            frontend stuff!
          </p>
          <p className="text-center mt-2">
            <a href="https://twitter.com/prerakhere" target="_blank">
              <svg
            ...
            <a href="https://github.com/prerak-jain" target="_blank">
              <svg
                className="inline w-6 h-6"
